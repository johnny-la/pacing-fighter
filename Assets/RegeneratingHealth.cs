...
public class RegeneratingHealth : MonoBehaviour 
{
	...
	{
		// Determine the character's current health percentage 
		float currentHealthPercent = character.CharacterStats.HealthPercent;

		// If the character's health percentage is below the desired value, keep regenerating
		while(currentHealthPercent < percentHealth)
		{
