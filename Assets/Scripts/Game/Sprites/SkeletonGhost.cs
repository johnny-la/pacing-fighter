...
/// <summary>
/// This adaptation of the SkeletonGhost is identical to the one provided in the Spine runtime.
/// However, ghosts can be placed in front of the skeleton.
/// </summary>
	 ...
	 */
		...
		protected virtual void Update () {
			...
			if (Time.time >= nextSpawnTime) {
				...
				pool[poolIndex].Initialize(meshFilter.sharedMesh, materials, color, additive, fadeSpeed, meshRenderer.sortingOrder + 
				                           																				((renderInFront)? 1 : -1));
				go.transform.parent = transform;
				
				go.transform.localPosition = Vector3.zero + new Vector3(0,0, (renderInFront)? -0.01f : 0.01f);
