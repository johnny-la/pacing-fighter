...
public class MoveSet : MonoBehaviour 
{
	...
	/// </summary>
	public ActionInfo[] attackMoves = new ActionInfo[0];

	/// <summary>
	/// Returns an action from this move set that can performed from the given
	/// input
	/// </summary>
	public ActionInfo GetValidAction(InputType inputType, InputRegion inputRegion,
